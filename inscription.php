            ...
            <div class="form-signin">
                <div class="panel panel-default">
                    <div class="panel-body">
                       ...
                       <div class="cadre1"> 
                        <form action="preferences.php" class="form-signin" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <p align="right">  <a class="btn btn-default" href="./index.php" role="button">Retour</a> <input type="submit" class="btn btn-primary" value=" Suivant >> "/></p>
