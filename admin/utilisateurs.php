...
if (!empty($_POST['supprimer'])) {
    foreach ($_POST['supprimer'] as $cle) {
        $Requete = "DELETE FROM users WHERE id = '$cle'";
        $resRequete = mysql_query($Requete) or die(mysql_error());
    }
    header("Refresh: 1;URL=utilisateurs.php");
}
...
<html>
    <head>
        ...
        <title>INF3005 - Gestion des utilisateurs</title>
        <!-- Bootstrap core CSS -->
        ...
        <script type="text/javascript" language="javascript">
            ...
            function confirme( identifiant )
            {
                ...
                if( confirmation )
                {
                    document.location.href = "supprimer_utilisateur.php?id="+identifiant ;
                }
            }
                    ...
                    <div class="panel-body"> 
                        <nav>
                            <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="utilisateurs.php" title="Utilisateurs">Utilisateurs</a></li>
                        ...
                        <div  class="cadre" id="cadre" >
                            ...
                            <p class="titre1"><b> <span class="glyphicon glyphicon-user"></span> Gestion des utilisateur :</b></p>
                            </br>
                                ...
                                <table class="table table-condensed" width="100%"  border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    do {
                                        ...
                                        <tr OnMouseOver="this.style.backgroundColor = '#E4EFFF';" OnMouseOut="this.style.backgroundColor = '<?php echo $bg; ?>';" style="background-color:<?php echo $bg; ?>; ">
                                            ...
                                            <td align="center" valign="middle"><?php echo $row_ss['id']; ?></td>
                                            <td align="left" valign="middle"><?php echo $row_ss['username']; ?></td>
                                            <td valign="middle"><?php echo $row_ss['first_name']; ?></td>
                                            <td valign="middle"><a href="mailto:<?php echo $row_ss['email']; ?>"><?php echo $row_ss['email']; ?></a></td>
                                            <td align="left">
                                                <a href="modifier_utilisateur.php?id=<?php echo $row_ss['id']; ?>" title="Modifier"><span class="glyphicon glyphicon-edit"></span></a>  

                                                <a href="#" onClick="confirme('<?php echo $row_ss['id']; ?>')" title="Supprimer"><span class="glyphicon glyphicon-remove"></span></a></td>
                                        ...
                                        <td colspan="7"> <br>
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#C4C4C4">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary" href="ajouter_utilisateur.php" role="button">Ajouter</a>
