...
$id = $_GET['id'];
$req = mysql_query('select * from users where id="' . $id . '"') or die(mysql_error());
...
<html>
    <head>
        ...
        <title>INF3005 - Modifier utlisateur</title>
        <!-- Bootstrap core CSS -->
            ...
            <div class="form-signin">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="cadre">
                            <p class="titre"><b> <span class="glyphicon glyphicon-user"></span> Modifier utilisateur :</b></p>
                            <form action="modifier_preferences.php" class="form-signin" role="form" method="post" enctype="multipart/form-data">
                                <label>Nom d'utilisateur : </label>
                                <input type="text" class="form-control" name="username" value="<?php echo $dn['username']; ?>" placeholder="Nom utilisateur" required autofocus />
                                <label>Mot de passe : </label>
                                <input type="password" class="form-control" name="password" value="<?php echo $dn['password']; ?>" placeholder="Mot de passe" required />
                                <label>Nom : </label>
...
?>>YT</option>
                                ...
                                <a class="btn btn-default" href="./utilisateurs.php" role="button">Retour</a> <input type="submit" class="btn btn-primary" value="Suivant >> "/>
                            </form>
                        </div>   
                    </div> 
                </div>       
