            ...
            <div class="form-signin">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <div class="cadre"> 
                            <form action="enregistrement_utilisateur.php" class="form-signin" role="form" method="post" enctype="multipart/form-data">
...
//            echo "Temp file: " . $_FILES["file"]["tmp_name"] . "<br>";
    ...
    $req = mysql_query('UPDATE users SET username = "' . $username . '" ,  password = "' . $password . '" , first_name = "' . $nom . '" ,  last_name = "' . $prenom . '" ,  email = "' . $email . '" ,  nrue = "' . $nrue . '" ,  rue = "' . $rue . '" ,  ville = "' . $ville . '" ,  province= "' . $province . '" ,  cp = "' . $cp . '" ,  pays = "' . $pays . '" ,  telephone = "' . $telephone . '" ,  photo = "' . $photo . '" WHERE username = "' . $username . '"');
    mysql_query($req);
    mysql_close();
}
?>