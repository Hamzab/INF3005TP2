...
<html>
    <head>
        ...
        <title>Administration - Ajouter utilisateur</title>
        <!-- Bootstrap core CSS -->
...
<div  class="cadre" id="cadre" >
                        <form action="enregistrer_utilisateur.php" class="form-signin" role="form" method="post" enctype="multipart/form-data">
                        <input type="hidden" class="form-control" name="username" value="<?php echo $username ; ?>" />
                            <table class='table table-condensed'>
                                <tr class="success"><th><span class="glyphicon glyphicon-ok-sign"></span> Préférences :</th></tr>      
