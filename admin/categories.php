...
$query_ss = "SELECT * FROM categories";
...
if (!empty($_POST['supprimer'])) {
    foreach ($_POST['supprimer'] as $cle) {
        $Requete = "DELETE FROM categories WHERE id = '$cle'";
...
<html>
    <head>
        ...
        <title>INF3005 - Gestion des categories</title>
        <!-- Bootstrap core CSS -->
        ...
        <script type="text/javascript" language="javascript">
            ...
            function confirme( identifiant )
            {
                ...
                if( confirmation )
                {
                    document.location.href = "supprimer_categorie.php?id="+identifiant ;
                }
            }
                    ...
                    <div class="panel-body"> 
                        <nav>
                            <ul class="nav nav-pills">
                                ...
                                <li class="active"><a href="categories.php" title="Catégories">Catégories</a></li>
                        ...
                        <div  class="cadre" id="cadre" >
                            ...
                            <p class="titre1"><b> <span class="glyphicon glyphicon-list-alt"></span> Gestion des catégories :</b></p>
                            </br>
                                ...
                                <table class="table table-condensed" width="100%"  border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    do {
                                        ...
                                        <tr OnMouseOver="this.style.backgroundColor = '#E4EFFF';" OnMouseOut="this.style.backgroundColor = '<?php echo $bg; ?>';" style="background-color:<?php echo $bg; ?>; ">
                                            ...
                                            <td align="left">
                                                <a href="modifier_categorie.php?id=<?php echo $row_ss['id']; ?>" title="Modifier"><span class="glyphicon glyphicon-edit"></span></a>  
                                        ...
                                        <td colspan="7"> <br>
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#C4C4C4">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary" href="ajouter_categorie.php" role="button">Ajouter</a>
